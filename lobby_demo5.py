    ...
    def wave_hand(self, fpos):
        ...
        for client in self.slist:
            try:
                ...
                fpos[5] = -fpos[5]
                client.set_position(positions=fpos, reply_mode=3)  # Update command
...
if __name__=="__main__":
    ...
    # displayer.run()
    pos = [15., 15., 15., 15., 15., -15.]	# for the slow hand wave
    while(1):
        displayer.wave_hand(pos)
        displayer.wave_hand(pos)
